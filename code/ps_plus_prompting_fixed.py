...
ORIGINAL_PROMPT_TEMPLATE = ("""
    ...
    Input: "Familt Guy, The Simpons, Futurama, and South Park!!!!"
    Plan:
    - "Familt Guy" → correct spelling to "Family Guy"
    - "The Simpons" → correct spelling to "The Simpsons"
...
# Main logic
def main():
    parser = argparse.ArgumentParser(description="PS+ formalization evaluation")
    ...
    parser.add_argument("--out_prefix", default="ps_plus_prompting_results", help="Output file prefix (without extension)")
