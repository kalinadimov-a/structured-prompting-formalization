...
# Main logic
def main():
    parser = argparse.ArgumentParser(description="Oneshot formalization evaluation")
    ...
    parser.add_argument("--out_prefix", default="oneshot_prompting_results", help="Output file prefix (without extension)")
...
if __name__ == "__main__":
    ...
    print("--------------- Running oneshot prompting sript ---------------")
